...
// 블록을 한 칸 아래로 내리는 함수. 만약 더 내려갈 수 없을 경우 블록을 착지시키고 블록 재생성 및 스테이지 갱신, 재생성된 블록이 바로 움직일 수 없다면 게임 오버 처리
...
// 블록을 최대한 아래로 내려 착지시키고 블록 재생성 및 스테이지 갱신. 재생성된 블록이 바로 움직일 수 없다면 게임 오버 처리
